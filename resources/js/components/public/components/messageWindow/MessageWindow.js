...
const handleSendEmoji = () => {
    let emoji = new FormData
        ...
        emoji.append('text', currentEmoji)
            ...
            <div style={{ display: 'flex', flexDirection: 'column'}}>
                {
                   messages && messages.map(m => (
                      <Message chatColor={props.chatColor && props.chatColor} user={props.user.id} from={props.to && props.to.name} message={m} delete={() => handleDeleteMessage(m.id, m.sender_id)}/>
                    ))
                }
